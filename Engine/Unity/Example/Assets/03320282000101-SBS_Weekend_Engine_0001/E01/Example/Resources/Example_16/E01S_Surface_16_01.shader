Shader "E01/Example_16/E01S_Shader_16_01" {
	/*
	* Properties 영역은 Unity 에디터 상에 쉐이더 동작하는데 필요한 정보를 설정 할 수 있게
	...
	* 
	* 반면, 외부 옵션 이름은 Unity 에디터 상에 표시되는 이름이기 때문에 한글을 비롯한 다양한
	* 문자를 사용하는 것이 가능하다.
	*/
	Properties{
	...
	SubShader{
		...
		*/
		...
		/*
		* Properties 영역에 명시 된 옵션은 쉐이더 내부에서 상수의 역할을 수행한다. (즉, Unity
